...
public class TimedStraightDriveCommand extends LoggingCommandBase {
    ...
    public void execute() {
        ...
        pTerm          = DriveConstants.TIMED_STRAIGHT_DRIVE_PID_KP * currentError;
        iTerm         += DriveConstants.TIMED_STRAIGHT_DRIVE_PID_KI * currentError;
        dTerm         += DriveConstants.TIMED_STRAIGHT_DRIVE_PID_KD * diffError;
